...
def main(params_file):
    ...
    # gen_class.loadData(params['process_country_gender_output_file_country'],
    # params['process_country_gender_output_country_id'], params['country_classifier_model_file'])
    gen_class.loadModel(
        params['country_classifier_model_file'], params['process_country_gender_output_country_id'])
    t1 = time.time()
